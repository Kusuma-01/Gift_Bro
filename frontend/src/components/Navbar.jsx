...
import { Gift, Users, History, Sparkles, HelpCircle, CheckCircle, Info, ExternalLink } from 'lucide-react';

export default function Navbar() {
  const { activeTab, setActiveTab, recipients, aiStatus } = useApp();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="relative">
          ...
          >
            ...
            />
            <span>{aiStatus.is_live ? 'Live LLM Mode' : 'Demo Fallback Mode'}</span>
